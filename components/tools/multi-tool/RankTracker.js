          ...
          <div className="row mt-50">
            <div className="col-xl-8 col-lg-10 m-auto">
              ...
              <p className="font-md color-grey-500 mb-25">
                Introducing the &lsquo;Search & App Rank Tracker&rsquo; tool by
                Next Growth Labs! Stay on top of your online presence and app
                rankings effortlessly with our comprehensive platform.
              </p>
              <p className="font-md color-grey-500 mb-25">
                ...
                engines on the internet. Whether you&apos;re a digital marketer,
                SEO enthusiast, or website owner, this tool provides you with a
            ...
            <>
              {tabQueries[2].isFetching ? (
                ...
                <>
                  ...
                  <SerpInfo data={tabQueries[2].data} id={"Google"} />
                </>
              ) : (
                <DefaultMessage
                  message={
          ...
          {selectedSource === "bing" && (
            <>
              {tabQueries[3].isFetching ? (
                ...
                <>
                  {/* {showSignUpButton.serp && <GoogleSignInButton />} */}
                  <SerpInfo data={tabQueries[3].data} id={"Bing"} />
                </>
              ) : (
                <DefaultMessage
                  message={
          ...
          {selectedSource === "play" && (
            <>
              {tabQueries[0].isFetching ? (
                ...
                <>
                  {/* {showSignUpButton.serp && <GoogleSignInButton />} */}
                  <AppRanks data={tabQueries[0].data} device={"android"} />
                </>
              ) : (
                <DefaultMessage
                  message={
          ...
          {selectedSource === "apple" && (
            <>
              {tabQueries[1].isFetching ? (
                ...
                <>
                  {/* {showSignUpButton.serp && <GoogleSignInButton />} */}
                  <AppRanks data={tabQueries[1].data} device={"apple"} />
                </>
              ) : (
                <DefaultMessage
                  message={
