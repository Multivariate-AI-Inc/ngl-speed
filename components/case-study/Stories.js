...
const Stories = () => {
    ...
    const data = [
        {
            title: " 20x Organic Traffic Growth",
            color: "head-bg-2",
            img: "cross.png",
        },
        {
        ...
        {
            title: "Resolving Manual Action Penalty Through Strategic Data Analysis",
            color: "head-bg-3",
            img: "business.svg",
        },
        {
            title: "Fixing Manual Action for Spammy Structured Markup",
            color: "head-bg-4",
            img: "cross4.png",
        },
    ];
